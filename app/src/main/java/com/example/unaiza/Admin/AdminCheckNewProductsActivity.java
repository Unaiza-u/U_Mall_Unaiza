package com.example.unaiza.Admin;
...
import com.example.unaiza.Interface.ItemClickListener;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Products> options =
                ...
                .setQuery(unverifiedProductsRef
                        .orderByChild("productState").equalTo("Not Approved"),Products.class).build();
        ...
        unverifiedProductsRef
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        Toast.makeText(AdminCheckNewProductsActivity.this, "The item has been approved & now it is available for sale from the seller.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}